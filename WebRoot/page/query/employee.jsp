...
<html>
  ...
  <body>
	...
	<div class="easyui-panel" title="查询条件" style="width:100%;padding:30px 70px 30px 70px;">
		<div >
			人员姓名:
			<input id="employee_name" class="easyui-textbox" style="width:15%;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			职位:
			<input id="employee_post" class="easyui-textbox" style="width:15%">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div id="dlg" class="easyui-dialog" style="width: 400px; height: 380px; padding: 10px 20px;"
     ...
     <label>姓名</label> 
       ...
       <div class="fitem"> 
     <label>级别</label> 
           <input name="positionLevel" class="easyui-validatebox" required="true" /> 
       </div> 
       <div class="fitem"> 
      <label>入职日期</label> 
           <input name="entryDate" class="easyui-datebox" required="true" /> 
       </div> 
       <div class="fitem">
       <label>部门</label> 
           <input name="departmentId" class="easyui-vlidatebox" /> 
       </div> 
       <div class="fitem">
       <label>职位</label> 
           <input name="post" class="easyui-vlidatebox" /> 
       </div> 
       <div class="fitem">
       <label>学历</label> 
